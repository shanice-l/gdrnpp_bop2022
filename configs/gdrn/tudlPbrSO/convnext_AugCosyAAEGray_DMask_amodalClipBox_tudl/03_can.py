...
OUTPUT_DIR = "output/gdrn/tudlPbrSO/convnext_AugCosyAAEGray_DMask_amodalClipBox_tudl/can"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("tudl_can_train_pbr",),
    TEST=("tudl_bop_test",),
    # AP        AP50    AP75    AR      inf.time
    DET_FILES_TEST=("datasets/BOP_DATASETS/tudl/test/test_bboxes/yolox_x_640_tudl_pbr_tudl_bop_test.json",),
)
