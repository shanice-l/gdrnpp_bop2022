...
OUTPUT_DIR = "output/gdrn/hbPbrSO/convnext_AugCosyAAEGray_DMask_amodalClipBox_hb/01_bear"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
VAL = dict(
    ...
    SAVE_BOP_CSV_ONLY=True,  # NOTE: for hb_test, no gt
)
