...
im_vis = vis_image_bboxes_cv2(im_vis, [bbox_xyxy], draw_center=True, box_thickness=3)
save_path = osp.expanduser(osp.join("~/vis_gdr_net/", "vis_DZI_256.png"))
