...
def create_renderer(
    ...
    elif renderer_type == "pyrender":
        from . import renderer_pyrender

        return renderer_pyrender.Renderer(width, height, mode=mode, bg_color=bg_color)

    elif renderer_type == "vispy":
        from . import renderer_vispy

        return renderer_vispy.RendererVispy(width, height, mode, shading=shading, bg_color=bg_color)
