...
def test_single_char_arguments():
    """Tests failures for passing invalid inputs to char-accepting
    functions."""
...
def test_builtins_cast_return_none():
    """Casters produced with PYBIND11_TYPE_CASTER() should convert nullptr to
    None."""
...
def test_none_deferred():
    """None passed as various argument types should defer to other
    overloads."""
...
def test_int_long():
    """In Python 2, a C++ int should return a Python int rather than long if
    possible: longs are not always accepted where ints are used (such as the
    argument to sys.exit()).

    A C++ long long is always a Python long.
    """
