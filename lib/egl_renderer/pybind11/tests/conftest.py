...
Extends output capture as needed by pybind11: ignore constructors,
optional unordered lines. Adds docstring and exceptions message
sanitizers: ignore Python 2 vs 3 differences.
"""
...
def _make_explanation(a, b):
    """Explanation for a failed assert -- the a and b arguments are
    List[str]"""
...
def gc_collect():
    """Run the garbage collector twice (needed when running reference counting
    tests with PyPy)"""
    gc.collect()
    gc.collect()
